...
query(any_reason_pattern(completed(straight,point(24.0,-4.5)))).
...
query(any_reason_pattern(no_path(straight,point(24.0,-4.5)))).
...
query(any_reason_pattern_by_action(completed(straight,point(24.0,-4.5)),a1)).
query(any_reason_pattern_by_action(no_path(straight,point(24.0,-4.5)),a1)).
...
query(any_reason_pattern_by_action(completed(straight,point(32.0,-4.5)),a3)).
query(any_reason_pattern_by_action(no_path(straight,point(32.0,-4.5)),a3)).
...
query(any_reason_pattern_by_action(completed(straight,point(32.0,-27.0)),a5)).
query(any_reason_pattern_by_action(no_path(straight,point(32.0,-27.0)),a5)).
...
query(any_reason_pattern_by_action(completed(straight,point(45.5,-31.5)),a8)).
query(any_reason_pattern_by_action(no_path(straight,point(45.5,-31.5)),a8)).
