...
query(any_reason_pattern(completed(astar,point(11.675,11.525)))).
query(any_reason_pattern(crashed(wild))).
query(any_reason_pattern(no_path(astar,point(11.675,11.525)))).

query(any_reason_pattern_by_action(completed(astar,point(11.675,11.525)),a1)).
query(any_reason_pattern_by_action(no_path(astar,point(11.675,11.525)),a1)).
