...
query(any_reason_pattern_by_action(completed(straight,[point(18.5,-13.5),point(18.5,0.0),point(9.5,0.0)]),a1)).
query(any_reason_pattern_by_action(no_path(straight,[point(18.5,-13.5),point(18.5,0.0),point(9.5,0.0)]),a1)).
