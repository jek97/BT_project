...
reactive_children(rc1, [cond(battery_over(70.0)),planWith(straight,point(22.275,2.075),CP,a1),moveto_leg(CP,[collision,battery,guard_break(battery_over(70.0),rc1)],a2),cond(distance_below(22.275,2.075,0.3))]).
