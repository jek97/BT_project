...
query(any_reason_pattern(completed(straight,point(12.6,-20.0)))).
query(any_reason_pattern(completed(straight,point(12.6,0.0)))).
query(any_reason_pattern(crashed(wild))).
query(any_reason_pattern(guard_break(battery_over(70.0)))).
query(any_reason_pattern(no_path(straight,point(12.6,-20.0)))).
query(any_reason_pattern(no_path(straight,point(12.6,0.0)))).

query(any_reason_pattern_by_action(completed(straight,point(12.6,-20.0)),a1)).
query(any_reason_pattern_by_action(no_path(straight,point(12.6,-20.0)),a1)).
...
query(any_reason_pattern_by_action(completed(straight,point(12.6,0.0)),a3)).
query(any_reason_pattern_by_action(no_path(straight,point(12.6,0.0)),a3)).
