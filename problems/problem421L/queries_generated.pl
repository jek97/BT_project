...
query(any_reason_pattern_by_action(completed(straight,point(32.0,-27.0)),a1)).
query(any_reason_pattern_by_action(no_path(straight,point(32.0,-27.0)),a1)).
...
query(any_reason_pattern_by_action(completed(straight,point(32.0,-27.0)),a4)).
query(any_reason_pattern_by_action(no_path(straight,point(32.0,-27.0)),a4)).
...
query(any_reason_pattern_by_action(sample_success(wild,wild,wild,sample_tree_11),a6)).
query(any_reason_pattern_detail_by_action(sample_success(_,_,_,sample_tree_11),a6)).
query(any_reason_pattern_by_action(sample_failure(wild,wild,sample_tree_11),a6)).
query(any_reason_pattern_detail_by_action(sample_failure(_,_,sample_tree_11),a6)).
query(any_reason_pattern_by_action(completed(straight,point(32.0,-27.0)),a7)).
query(any_reason_pattern_by_action(no_path(straight,point(32.0,-27.0)),a7)).
...
query(any_reason_pattern_by_action(sample_success(wild,wild,wild,sample_tree_11),a9)).
query(any_reason_pattern_detail_by_action(sample_success(_,_,_,sample_tree_11),a9)).
query(any_reason_pattern_by_action(sample_failure(wild,wild,sample_tree_11),a9)).
query(any_reason_pattern_detail_by_action(sample_failure(_,_,sample_tree_11),a9)).
