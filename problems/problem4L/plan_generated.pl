...
%   a1: PlanWith(straight, goal=point(24.0,-4.5)) [TryGoal]
%   a2: MoveTo(CP) [TryGoal]
%   a3: PlanWith(straight, goal=point(11.3,-15.0)) [GoHome]
%   a4: MoveTo(CP2) [GoHome]
%
% Condition code legend (see main.py's own printed copy of this):
%   c1: BatteryOver(threshold=70) [TryGoal]
%   c2: DistanceBelow(goal=24.0;-4.5,threshold=0.3) [TryGoal]
%   c3: DistanceBelow(goal=11.3;-15.0,threshold=0.3) [GoHome]

plan(fallback_node([reactivesequence(rc1),seq_node([planWith(straight,point(11.3,-15.0),CP2,a3),moveto_leg(CP2,[collision,battery],a4),cond(distance_below(11.3,-15.0,0.3),c3)])])).
...
reactive_children(rc1, [cond(battery_over(70.0),c1),planWith(straight,point(24.0,-4.5),CP,a1),moveto_leg(CP,[collision,battery,guard_break(battery_over(70.0),rc1)],a2),cond(distance_below(24.0,-4.5,0.3),c2)]).
