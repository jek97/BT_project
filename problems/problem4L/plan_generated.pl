...
reactive_children(rc1, [seq_node([cond(battery_below(50.0),c1),fallback_node([cond(distance_below(11.3,-15.0,1.0),c2),seq_node([planWith(dastar(2.0),point(11.3,-15.0),CP1,a1),moveto_leg(CP1,[collision,battery],a2),cond(distance_below(11.3,-15.0,1.0),c3)])])]),seq_node([fallback_node([cond(distance_below(32.0,-3.3,1.0),c4),seq_node([planWithWaypoints(straight,[point(22.0,-15.0),point(22.0,-3.3),point(32.0,-3.3)],CP1,a3),moveto_leg(CP1,[collision,battery],a4),cond(distance_below(32.0,-3.3,1.0),c5)])]),take_sample(sample_tree_11,a5),fallback_node([cond(distance_below(45.5,-36.0,1.0),c6),seq_node([planWithWaypoints(straight,[point(32.0,-27.0),point(45.5,-27.0),point(45.5,-36.0)],CP2,a6),moveto_leg(CP2,[collision,battery],a7),cond(distance_below(45.5,-36.0,1.0),c7)])])])]).
