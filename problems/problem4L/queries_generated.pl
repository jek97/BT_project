...
query(any_reason_pattern_by_action(completed(voronoi,point(11.3,-15.0)),a1)).
query(any_reason_pattern_by_action(no_path(voronoi,point(11.3,-15.0)),a1)).
...
query(any_reason_pattern_by_action(completed(straight,[point(22.0,-15.0),point(22.0,-3.3),point(32.0,-3.3)]),a3)).
query(any_reason_pattern_by_action(no_path(straight,[point(22.0,-15.0),point(22.0,-3.3),point(32.0,-3.3)]),a3)).
...
query(any_reason_pattern_by_action(completed(straight,[point(22.0,-3.3),point(22.0,-15.0),point(11.3,-15.0)]),a8)).
query(any_reason_pattern_by_action(no_path(straight,[point(22.0,-3.3),point(22.0,-15.0),point(11.3,-15.0)]),a8)).
