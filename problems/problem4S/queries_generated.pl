...
query(any_reason_pattern(completed(dastar(2.0),point(0.0,-13.5)))).
...
query(any_reason_pattern(no_path(dastar(2.0),point(0.0,-13.5)))).
...
query(any_reason_pattern_by_action(completed(dastar(2.0),point(0.0,-13.5)),a1)).
query(any_reason_pattern_by_action(no_path(dastar(2.0),point(0.0,-13.5)),a1)).
